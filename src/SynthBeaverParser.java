...
public class SynthBeaverParser extends Parser {
	...
	public static final int
		...
		RULE_arguments = 17, RULE_argument = 18, RULE_play = 19, RULE_functionDef = 20, 
		RULE_argumentsDef = 21, RULE_argumentDef = 22, RULE_name = 23, RULE_type = 24, 
		RULE_condition = 25;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "instructions", "instruction", "definition", "mutability", "control", 
			"while", "for", "if", "block", "body", "expression", "operator", "function", 
			"literal", "boolLiteral", "lambda", "arguments", "argument", "play", 
			"functionDef", "argumentsDef", "argumentDef", "name", "type", "condition"
		};
	}
	...
	public final ArgumentsDefContext argumentsDef() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_argumentsDef);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ArgumentDefContext argumentDef() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_argumentDef);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(191);
